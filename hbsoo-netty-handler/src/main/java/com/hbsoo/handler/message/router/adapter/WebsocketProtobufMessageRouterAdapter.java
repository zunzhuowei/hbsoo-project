...
/**
 * websocket protobuf消息处理器
 * Created by zun.wei on 2021/7/31.
 */
public abstract class WebsocketProtobufMessageRouterAdapter<T extends GeneratedMessageV3> implements MessageRouter<HBSMessage<byte[]>> {

    protected Channel channel;

    @Override
    public ServerProtocolType getProtocolType() {
        return ServerProtocolType.WEBSOCKET_PROTOBUF;
    }
